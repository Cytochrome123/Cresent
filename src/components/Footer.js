                    ...
                    <div class="dtr-accordion accordion" id="home-accordion"> 
                        ...
                        <div class="card">
                            <div class="card-header" id="headingOne">
                                <h2 class="dtr-mb-0">
                                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"><i class="icon-phone-call dtr-left-icon dtr-icon-scale"></i> Contact </button>
                                </h2>
                            </div>
